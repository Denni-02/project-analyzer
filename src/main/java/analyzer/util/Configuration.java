...
public class Configuration {
    ...
    public static final String OUTPUT_ARFF1_PATH = "/home/denni/isw2/project-analyzer/csv_output/bookkeeper_output.arff";
    public static final String PROJECT1_NAME = "BOOKKEEPER";
